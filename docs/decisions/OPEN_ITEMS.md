...
- [x] True VADER-vs-contrastive sentiment accuracy comparison (currently only generic-embedding-vs-contrastive-embedding has been measured) - raised in `docs/decisions/0006-contrastive-sentiment-model.md`, targeted: Week 9. Closed in `docs/decisions/0011-week9-evaluation-vader-clustering-loto-breakdown.md`.
- [x] Leave-one-thesis-out (LOTO) per-fold easy/hard-negative accuracy breakdown (currently only computed for the fixed-split model) - raised in `docs/decisions/0003-contrastive-relevance-model-training-and-evaluation.MD`, targeted: Week 9. Closed in `docs/decisions/0011-week9-evaluation-vader-clustering-loto-breakdown.md`.
